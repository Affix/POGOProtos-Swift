...
// Source file "DownloadRemoteConfigVersionMessage.proto"
// Syntax "Proto3"
...
public extension Pogoprotos.Networking.Requests.Messages {
  public struct DownloadRemoteConfigVersionMessageRoot {
    public static var sharedInstance : DownloadRemoteConfigVersionMessageRoot {
     struct Static {
         static let instance : DownloadRemoteConfigVersionMessageRoot = DownloadRemoteConfigVersionMessageRoot()
     }
  ...
  final public class DownloadRemoteConfigVersionMessage : GeneratedMessage, GeneratedMessageProtocol {
    ...
    public class func parseFromData(data:NSData) throws -> Pogoprotos.Networking.Requests.Messages.DownloadRemoteConfigVersionMessage {
      return try Pogoprotos.Networking.Requests.Messages.DownloadRemoteConfigVersionMessage.Builder().mergeFromData(data, extensionRegistry:Pogoprotos.Networking.Requests.Messages.DownloadRemoteConfigVersionMessageRoot.sharedInstance.extensionRegistry).build()
    }
