...
// Source file "SetContactSettingsResponse.proto"
// Syntax "Proto3"
...
public extension Pogoprotos.Networking.Responses {
  public struct SetContactSettingsResponseRoot {
    public static var sharedInstance : SetContactSettingsResponseRoot {
     struct Static {
         static let instance : SetContactSettingsResponseRoot = SetContactSettingsResponseRoot()
     }
  ...
  final public class SetContactSettingsResponse : GeneratedMessage, GeneratedMessageProtocol {
    ...
    public class func parseFromData(data:NSData) throws -> Pogoprotos.Networking.Responses.SetContactSettingsResponse {
      return try Pogoprotos.Networking.Responses.SetContactSettingsResponse.Builder().mergeFromData(data, extensionRegistry:Pogoprotos.Networking.Responses.SetContactSettingsResponseRoot.sharedInstance.extensionRegistry).build()
    }
