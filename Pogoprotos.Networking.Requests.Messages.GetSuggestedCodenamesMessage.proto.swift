...
// Source file "GetSuggestedCodenamesMessage.proto"
// Syntax "Proto3"
...
public extension Pogoprotos.Networking.Requests.Messages {
  public struct GetSuggestedCodenamesMessageRoot {
    public static var sharedInstance : GetSuggestedCodenamesMessageRoot {
     struct Static {
         static let instance : GetSuggestedCodenamesMessageRoot = GetSuggestedCodenamesMessageRoot()
     }
  ...
  final public class GetSuggestedCodenamesMessage : GeneratedMessage, GeneratedMessageProtocol {
    ...
    public class func parseFromData(data:NSData) throws -> Pogoprotos.Networking.Requests.Messages.GetSuggestedCodenamesMessage {
      return try Pogoprotos.Networking.Requests.Messages.GetSuggestedCodenamesMessage.Builder().mergeFromData(data, extensionRegistry:Pogoprotos.Networking.Requests.Messages.GetSuggestedCodenamesMessageRoot.sharedInstance.extensionRegistry).build()
    }
