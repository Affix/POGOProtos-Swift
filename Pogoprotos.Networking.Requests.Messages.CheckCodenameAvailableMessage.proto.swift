...
// Source file "CheckCodenameAvailableMessage.proto"
// Syntax "Proto3"
...
public extension Pogoprotos.Networking.Requests.Messages {
  public struct CheckCodenameAvailableMessageRoot {
    public static var sharedInstance : CheckCodenameAvailableMessageRoot {
     struct Static {
         static let instance : CheckCodenameAvailableMessageRoot = CheckCodenameAvailableMessageRoot()
     }
  ...
  final public class CheckCodenameAvailableMessage : GeneratedMessage, GeneratedMessageProtocol {
    ...
    public class func parseFromData(data:NSData) throws -> Pogoprotos.Networking.Requests.Messages.CheckCodenameAvailableMessage {
      return try Pogoprotos.Networking.Requests.Messages.CheckCodenameAvailableMessage.Builder().mergeFromData(data, extensionRegistry:Pogoprotos.Networking.Requests.Messages.CheckCodenameAvailableMessageRoot.sharedInstance.extensionRegistry).build()
    }
