...
// Source file "UseItemReviveMessage.proto"
// Syntax "Proto3"
...
public extension Pogoprotos.Networking.Requests.Messages {
  public struct UseItemReviveMessageRoot {
    public static var sharedInstance : UseItemReviveMessageRoot {
     struct Static {
         static let instance : UseItemReviveMessageRoot = UseItemReviveMessageRoot()
     }
  ...
  final public class UseItemReviveMessage : GeneratedMessage, GeneratedMessageProtocol {
    ...
    public class func parseFromData(data:NSData) throws -> Pogoprotos.Networking.Requests.Messages.UseItemReviveMessage {
      return try Pogoprotos.Networking.Requests.Messages.UseItemReviveMessage.Builder().mergeFromData(data, extensionRegistry:Pogoprotos.Networking.Requests.Messages.UseItemReviveMessageRoot.sharedInstance.extensionRegistry).build()
    }
