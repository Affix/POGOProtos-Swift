...
// Source file "GetHatchedEggsMessage.proto"
// Syntax "Proto3"
...
public extension Pogoprotos.Networking.Requests.Messages {
  public struct GetHatchedEggsMessageRoot {
    public static var sharedInstance : GetHatchedEggsMessageRoot {
     struct Static {
         static let instance : GetHatchedEggsMessageRoot = GetHatchedEggsMessageRoot()
     }
  ...
  final public class GetHatchedEggsMessage : GeneratedMessage, GeneratedMessageProtocol {
    ...
    public class func parseFromData(data:NSData) throws -> Pogoprotos.Networking.Requests.Messages.GetHatchedEggsMessage {
      return try Pogoprotos.Networking.Requests.Messages.GetHatchedEggsMessage.Builder().mergeFromData(data, extensionRegistry:Pogoprotos.Networking.Requests.Messages.GetHatchedEggsMessageRoot.sharedInstance.extensionRegistry).build()
    }
