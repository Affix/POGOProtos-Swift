...
// Source file "CheckCodenameAvailableResponse.proto"
// Syntax "Proto3"
...
public extension Pogoprotos.Networking.Responses {
  public struct CheckCodenameAvailableResponseRoot {
    public static var sharedInstance : CheckCodenameAvailableResponseRoot {
     struct Static {
         static let instance : CheckCodenameAvailableResponseRoot = CheckCodenameAvailableResponseRoot()
     }
  ...
  final public class CheckCodenameAvailableResponse : GeneratedMessage, GeneratedMessageProtocol {
    ...
    public class func parseFromData(data:NSData) throws -> Pogoprotos.Networking.Responses.CheckCodenameAvailableResponse {
      return try Pogoprotos.Networking.Responses.CheckCodenameAvailableResponse.Builder().mergeFromData(data, extensionRegistry:Pogoprotos.Networking.Responses.CheckCodenameAvailableResponseRoot.sharedInstance.extensionRegistry).build()
    }
