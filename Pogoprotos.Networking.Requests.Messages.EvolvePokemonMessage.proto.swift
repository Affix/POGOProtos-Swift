...
// Source file "EvolvePokemonMessage.proto"
// Syntax "Proto3"
...
public extension Pogoprotos.Networking.Requests.Messages {
  public struct EvolvePokemonMessageRoot {
    public static var sharedInstance : EvolvePokemonMessageRoot {
     struct Static {
         static let instance : EvolvePokemonMessageRoot = EvolvePokemonMessageRoot()
     }
  ...
  final public class EvolvePokemonMessage : GeneratedMessage, GeneratedMessageProtocol {
    ...
    public class func parseFromData(data:NSData) throws -> Pogoprotos.Networking.Requests.Messages.EvolvePokemonMessage {
      return try Pogoprotos.Networking.Requests.Messages.EvolvePokemonMessage.Builder().mergeFromData(data, extensionRegistry:Pogoprotos.Networking.Requests.Messages.EvolvePokemonMessageRoot.sharedInstance.extensionRegistry).build()
    }
