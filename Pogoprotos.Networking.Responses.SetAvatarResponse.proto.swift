...
// Source file "SetAvatarResponse.proto"
// Syntax "Proto3"
...
public extension Pogoprotos.Networking.Responses {
  public struct SetAvatarResponseRoot {
    public static var sharedInstance : SetAvatarResponseRoot {
     struct Static {
         static let instance : SetAvatarResponseRoot = SetAvatarResponseRoot()
     }
  ...
  final public class SetAvatarResponse : GeneratedMessage, GeneratedMessageProtocol {
    ...
    public class func parseFromData(data:NSData) throws -> Pogoprotos.Networking.Responses.SetAvatarResponse {
      return try Pogoprotos.Networking.Responses.SetAvatarResponse.Builder().mergeFromData(data, extensionRegistry:Pogoprotos.Networking.Responses.SetAvatarResponseRoot.sharedInstance.extensionRegistry).build()
    }
