...
// Source file "GetPlayerMessage.proto"
// Syntax "Proto3"
...
public extension Pogoprotos.Networking.Requests.Messages {
  public struct GetPlayerMessageRoot {
    public static var sharedInstance : GetPlayerMessageRoot {
     struct Static {
         static let instance : GetPlayerMessageRoot = GetPlayerMessageRoot()
     }
  ...
  final public class GetPlayerMessage : GeneratedMessage, GeneratedMessageProtocol {
    ...
    public class func parseFromData(data:NSData) throws -> Pogoprotos.Networking.Requests.Messages.GetPlayerMessage {
      return try Pogoprotos.Networking.Requests.Messages.GetPlayerMessage.Builder().mergeFromData(data, extensionRegistry:Pogoprotos.Networking.Requests.Messages.GetPlayerMessageRoot.sharedInstance.extensionRegistry).build()
    }
