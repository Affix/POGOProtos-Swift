...
// Source file "CollectDailyDefenderBonusMessage.proto"
// Syntax "Proto3"
...
public extension Pogoprotos.Networking.Requests.Messages {
  public struct CollectDailyDefenderBonusMessageRoot {
    public static var sharedInstance : CollectDailyDefenderBonusMessageRoot {
     struct Static {
         static let instance : CollectDailyDefenderBonusMessageRoot = CollectDailyDefenderBonusMessageRoot()
     }
  ...
  final public class CollectDailyDefenderBonusMessage : GeneratedMessage, GeneratedMessageProtocol {
    ...
    public class func parseFromData(data:NSData) throws -> Pogoprotos.Networking.Requests.Messages.CollectDailyDefenderBonusMessage {
      return try Pogoprotos.Networking.Requests.Messages.CollectDailyDefenderBonusMessage.Builder().mergeFromData(data, extensionRegistry:Pogoprotos.Networking.Requests.Messages.CollectDailyDefenderBonusMessageRoot.sharedInstance.extensionRegistry).build()
    }
