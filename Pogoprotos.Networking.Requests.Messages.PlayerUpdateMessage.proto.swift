...
// Source file "PlayerUpdateMessage.proto"
// Syntax "Proto3"
...
public extension Pogoprotos.Networking.Requests.Messages {
  public struct PlayerUpdateMessageRoot {
    public static var sharedInstance : PlayerUpdateMessageRoot {
     struct Static {
         static let instance : PlayerUpdateMessageRoot = PlayerUpdateMessageRoot()
     }
  ...
  final public class PlayerUpdateMessage : GeneratedMessage, GeneratedMessageProtocol {
    ...
    public class func parseFromData(data:NSData) throws -> Pogoprotos.Networking.Requests.Messages.PlayerUpdateMessage {
      return try Pogoprotos.Networking.Requests.Messages.PlayerUpdateMessage.Builder().mergeFromData(data, extensionRegistry:Pogoprotos.Networking.Requests.Messages.PlayerUpdateMessageRoot.sharedInstance.extensionRegistry).build()
    }
