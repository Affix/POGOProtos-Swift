...
// Source file "SfidaActionLogMessage.proto"
// Syntax "Proto3"
...
public extension Pogoprotos.Networking.Requests.Messages {
  public struct SfidaActionLogMessageRoot {
    public static var sharedInstance : SfidaActionLogMessageRoot {
     struct Static {
         static let instance : SfidaActionLogMessageRoot = SfidaActionLogMessageRoot()
     }
  ...
  final public class SfidaActionLogMessage : GeneratedMessage, GeneratedMessageProtocol {
    ...
    public class func parseFromData(data:NSData) throws -> Pogoprotos.Networking.Requests.Messages.SfidaActionLogMessage {
      return try Pogoprotos.Networking.Requests.Messages.SfidaActionLogMessage.Builder().mergeFromData(data, extensionRegistry:Pogoprotos.Networking.Requests.Messages.SfidaActionLogMessageRoot.sharedInstance.extensionRegistry).build()
    }
