...
public extension Pogoprotos.Map.Pokemon {
  public struct WildPokemonRoot {
    public static var sharedInstance : WildPokemonRoot {
     struct Static {
         static let instance : WildPokemonRoot = WildPokemonRoot()
     }
  ...
  final public class WildPokemon : GeneratedMessage, GeneratedMessageProtocol {
    ...
    public class func parseFromData(data:NSData) throws -> Pogoprotos.Map.Pokemon.WildPokemon {
      return try Pogoprotos.Map.Pokemon.WildPokemon.Builder().mergeFromData(data, extensionRegistry:Pogoprotos.Map.Pokemon.WildPokemonRoot.sharedInstance.extensionRegistry).build()
    }
